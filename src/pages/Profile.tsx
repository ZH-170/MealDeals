    ...
    return(
        <div className="pr-[150px] pl-[120px] py-6 flex flex-row gap-8 justify-between">
            <div className="flex flex-col w-[800px]">
                ...
                <div>
                    <div className="m-[60px]">
                        <h1 className="m-5 text-2xl font-extrabold ">Favourite Recipes</h1>
                    ...
                    <div className="m-[60px]">
                        <h1 className="m-5 text-2xl font-extrabold ">Followed Influencers</h1>
            ...
            <div className="bg-white mt-[100px] h-[450px] text-center flex flex-col items-top justify-center rounded-xl px-8 shadow-[0_4px_8px_rgba(0,0,0,0.1)]">
                <div className="w-[320px] h-[320px] flex items-center justify-center rounded-full border-2 border-black">
                    <img 
                        src="/wolf.jpg"
                        className="w-[200px]"
                    />
                ...
                <h1 className="mt-6 text-md font-extrabold text-primary">You've saved <span className="text-3xl">$20.11</span> with MealDeals!</h1>
            </div>
        </div>
    );
}
